...
@section('title', 'iPOS | List Of Sales')
...
@section('page_header') 
  <h1> Sales <small>List Of Sales</small> </h1>
  <ol class="breadcrumb">
...
<div class="box box-primary">
                <div class="box-header with-border">
                  <div class="col-md-10">
                    <a href="{{ route('sales.create')}}" class="btn btn-primary btn-lg"><i class="glyphicon glyphicon-plus"></i> Create New Sale</a>
                  </div>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<div class="modal fade" id="dialog-confirm_delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     {!! Form::open(['route' => ['sales.destroy','id' => 0], 'method' => 'DELETE', 'id' => 'deleteForm'])!!}
