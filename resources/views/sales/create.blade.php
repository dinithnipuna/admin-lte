...
@section('title', 'iPOS | Create New Sale')
...
@section('page_header')
  <h1> Sales <small>Create New Sale</small> </h1>
  <ol class="breadcrumb">
  ...
  <div class="col-md-8">
     <div class="box box-info">
      <div class="box-header with-border">
        ...
        <div class="box-body">
        <div class="col-xs-3">
            {!! Form::open(array('route' => 'sales.product','class' => 'form-horizontal','id' => 'getProduct')) !!}
...
<div class="col-md-4">
 ...
 <div class="box box-success">
    <div class="box-header with-border">
                ...
                <div class="box-body">
                   {!! Form::select('payment_type', array('cash' => 'Cash Payment','card' => 'Card Payment' ,'cheque' => 'Cheque Payment'), 'cash', ['id' => 'payment_type','class' => 'form-control','v-model'=> 'payment_type']) !!} 
                </div>
 </div>
  ...
  $( "#addProduct" ).submit(function( event ) {
   ...
   $( "#q" ).autocomplete({
    ...
    $( document ).delegate("#complete-sale","click",function(e){
        ...
        var dataString = "total="+total_amount+"&total_discount="+total_discount+"&charge="+card_payment_charge+"&customer_id="+customer_id+"&payment_type="+payment_type+"&items="+items;
        $.ajax({
              type: "POST",
