...
@section('title', 'iPOS | List Of Users')
...
<div class="box">
                <div class="box-header with-border">
                  <div class="col-md-10">
                    <a href="{{ route('users.create')}}" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i>Add New User</a>
                  </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                <table class="table table-striped table-bordered table-hover dt-responsive" cellspacing="0" width="100%" id="users-table">
                  <thead>
                      <tr>
                          <th>ID</th>
                          <th>First Name</th>
