...
@section('page_header')
   <h1> Sales <small>Edit Bill</small> </h1>
  <ol class="breadcrumb">
...
<div class="col-md-4">
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
          ...
          <div class="input-group"> 
              {!! Form::hidden('id',$bill->id , ['id' =>  'sale_id', 'class'=>'form-control'])!!}   
               {!! Form::text('customers', $bill->customer->name, ['id' =>  'customers', 'placeholder' =>  'Search Customer...', 'class'=>'form-control'])!!}
               <span class="input-group-btn">
               ...
               {!! Form::hidden('customer_id', $bill->customer_id, array('id' => 'customer_id')) !!}
 ...
 <div class="box box-success">
    <div class="box-header with-border">
                ...
                <div class="box-body">
                   {!! Form::select('payment_type', array('cash' => 'Cash Payment','card' => 'Card Payment' ,'cheque' => 'Cheque Payment'), $bill->payment_type, ['id' => 'payment_type','class' => 'form-control','v-model'=> 'payment_type', 'v-on:change'=>'greet']) !!} 
                </div>
 </div>
  ...
  $( "#addProduct" ).submit(function( event ) {
   ...
   $( "#q" ).autocomplete({
    ...
    $( document ).delegate("#complete-sale","click",function(e){
        ...
        var dataString = "id="+id+"&total_amount="+total_amount+"&total_discount="+total_discount+"&card_payment_charge="+card_payment_charge+"&customer_id="+customer_id+"&payment_type="+payment_type+"&items="+items;
        $.ajax({
              type: "PUT",
