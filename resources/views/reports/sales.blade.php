...
@section('title', 'iPOS | Sales Report')
...
@section('page_header')
   <h1> Reports <small>Sales Report</small> </h1>
  <ol class="breadcrumb">
    ...
    <div class="box">
     <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-file-text "></i> Sales Report</li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1-1">
              <div class="row">
                <!-- form start -->
                {!! Form::open(array('route' => 'reports.trial_balance','class' => 'form-horizontal', 'id' => 'annual')) !!}
              ...
              <div class="tab-pane" id="tab_2-2">
                <div class="row">
                <!-- form start -->
                {!! Form::open(array('route' => 'reports.trial_balance','class' => 'form-horizontal', 'id' => 'monthly')) !!}
              ...
              <div class="tab-pane" id="tab_3-2">
               <div class="row">
                <!-- form start -->
                {!! Form::open(array('route' => 'reports.trial_balance','class' => 'form-horizontal', 'id' => 'daily')) !!}
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $( "#annual" ).submit(function( event ) {
              ...
              $.post('{!! route('reports.trial_balance') !!}', $.param($(this).serializeArray()), function(data) {
